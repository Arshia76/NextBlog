...
const AddPostPage = () => {
  ...
  return (
    <div className='w-full min-h-[80vh] px-20 md:px-0 flex items-center justify-center'>
      <div className='border border-solid border-gray-200 rounded-md w-full md:w-1/2 max-w-6xl mx-auto shadow-xl my-8 py-12  h-fit px-24 flex flex-col '>
        <h2 className='text-5xl mb-12 text-center'>افزودن پست</h2>
        <input
       ...
       border-gray-400  bg-gray-400 rounded-md text-white text-2xl py-4 px-6
